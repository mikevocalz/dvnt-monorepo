...
export function getWeatherSoundAsset(
  ...
  switch (effect) {
    ...
    //   return {
    //     source: require("@dvnt/app/assets/audio/weather/rain_light_loop.mp3"),
    ...
    //   return {
    //     source: require("@dvnt/app/assets/audio/weather/rain_heavy_loop.mp3"),
    ...
    //   return {
    //     source: require("@dvnt/app/assets/audio/weather/snow_ambient_loop.mp3"),
    ...
    //   return {
    //     source: require("@dvnt/app/assets/audio/weather/thunder_distant_loop.mp3"),
    ...
    //   return {
    //     source: require("@dvnt/app/assets/audio/weather/wind_loop.mp3"),
    //     name: "wind_loop",
    //     loop: true,
    //     baseVolume: 0.3,
    //   };
