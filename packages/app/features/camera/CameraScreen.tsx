      ...
      <View className="flex-1 rounded-[20px] overflow-hidden m-1">
        {lastCapture.type === "image" ? (
          ...
          <View className="flex-1 bg-neutral-900">
            <VideoView
              // expo-video's web VideoView types the player as VideoPlayerWeb &
              // VideoPlayer; on native it's VideoPlayer. Cast to the prop's own
              // type so the universal file checks under both platforms.
