...
export const LOCAL_STICKER_MODULES = {
  dvnt: [
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_APP.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_AfterHours.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_CounterCulture.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_DAYPLAY.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_Deviant.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_EnergyCheck.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_FTC.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/DVNT-stickers_OUTSIDE.png"),
    require("@dvnt/app/assets/images/stickers/dvnt/eat-it.png"),
  ],
  ballroom: [
    require("@dvnt/app/assets/images/stickers/ballroom/1-chop.png"),
    require("@dvnt/app/assets/images/stickers/ballroom/serve.png"),
    require("@dvnt/app/assets/images/stickers/ballroom/category-is.png"),
    require("@dvnt/app/assets/images/stickers/ballroom/ate-that.png"),
    require("@dvnt/app/assets/images/stickers/ballroom/tea.png"),
  ],
} as const;
