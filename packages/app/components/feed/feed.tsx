...
import { seedLikeState } from "@dvnt/app/lib/hooks/usePostLikeState";
import { prefetchComments } from "@dvnt/app/lib/hooks/use-comments";
...
import { useDeletePost } from "@dvnt/app/lib/hooks/use-posts";
...
const EMPTY_MEDIA: import("@dvnt/app/lib/types").PostMediaItem[] = [];
