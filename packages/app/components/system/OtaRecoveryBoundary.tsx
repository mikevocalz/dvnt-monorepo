...
import { didCrashOnPendingUpdate, getPendingUpdateIdAtBoot } from "@dvnt/app/lib/ota/updateSafety";
import { getBootDiagnostics } from "@dvnt/app/lib/boot-guard";
...
export class OtaRecoveryBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    ...
    safeGet(() => {
      // eslint-disable-next-line @typescript-eslint/no-var-requires
      const { mmkv } = require("@dvnt/app/lib/mmkv-zustand");
