...
-- project (20260613145108 :: cart_addons_holds). This migration was applied to production
-- out-of-band and had no file in this directory; the SQL below is the
-- statement array the ledger recorded, so the repo now replays to the
-- schema production actually runs. Already recorded as applied.

-- Add-ons through cart_holds + cart_create_hold v2 (tier pricing + atomic addon oversell).
...
DO $$ BEGIN ALTER TABLE public.cart_line_items ALTER COLUMN tier_id DROP NOT NULL; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.cart_holds ALTER COLUMN tier_id DROP NOT NULL; EXCEPTION WHEN others THEN NULL; END $$;
...
CREATE OR REPLACE FUNCTION public.cart_create_hold(p_cart_id uuid, p_hold_seconds integer DEFAULT 600)
