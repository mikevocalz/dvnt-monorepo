-- ============================================================
-- Fix get_event_detail + get_events_home: SECURITY DEFINER
-- These batch RPCs aggregate data from multiple tables with
-- different RLS policies. They must run as owner (postgres)
-- to access ticket_types, event_reviews, event_comments, etc.
-- ============================================================
...
-- ── 2. get_events_home — also needs SECURITY DEFINER ──────────
...
GRANT EXECUTE ON FUNCTION public.get_events_home(integer, integer, integer, integer, boolean, boolean, boolean, text, text) TO authenticated, anon, service_role;
