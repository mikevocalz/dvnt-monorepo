...
-- project (20260614001317 :: issue_guest_rsvp_tickets_cart_grouping). This migration was applied to production
...
begin
  ...
  -- Guest cart for grouping the N tickets (carts.user_id is not a FK → guest sentinel).
