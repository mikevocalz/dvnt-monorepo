...
-- project (20260521000426 :: v2_db_06c_event_detail_remove_deleted_at_filter). This migration was applied to production
-- out-of-band and had no file in this directory; the SQL below is the
-- statement array the ledger recorded, so the repo now replays to the
-- schema production actually runs. Already recorded as applied.

-- event_reviews has no deleted_at column. Remove filters that
-- assumed it existed (introduced by mistake in 06b).
