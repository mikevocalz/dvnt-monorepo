...
-- project (20260521000525 :: v2_db_06d_event_detail_use_author_id_for_comments). This migration was applied to production
-- out-of-band and had no file in this directory; the SQL below is the
-- statement array the ledger recorded, so the repo now replays to the
-- schema production actually runs. Already recorded as applied.

-- event_comments uses author_id (integer FK to users.id), not user_id.
...
BEGIN
  ...
  FROM (
    SELECT
      ...
      e.flyer_image_url, e.youtube_video_url,
